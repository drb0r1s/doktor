...
pub const PACKET_BACKGROUND_COLOR_ALPHA: usize = 6;

pub const PACKET_STRING_OFFSET: usize = 7;
pub const PACKET_STRING_LENGTH: usize = 8;

pub const PACKET_CONTENT_COLOR: usize = 9;
pub const PACKET_CONTENT_COLOR_ALPHA: usize = 10;
pub const PACKET_CONTENT_SIZE: usize = 11;
pub const PACKET_CONTENT_FONT: usize = 12;

pub const PACKET_BORDER_COLOR: usize = 13;
